...
extern void cgr101_digitizer_input_offset(struct info *info,
                                          double f1,
                                          double f2,
                                          double f3,
                                          double f4);
extern void cgr101_digitizer_input_offset_store(struct info *info);
extern void cgr101_digitizer_input_offsetq(struct info *info);
